...
os.environ["REPLICATE_API_TOKEN"] = "r8_C1ukGNTeyDpRoViflDoowmDuCKImaX80ufML9"
...
def index():
    if request.method == "POST":
        ...
        headers = {'Authorization': 'Token r8_C1ukGNTeyDpRoViflDoowmDuCKImaX80ufML9','Content-Type': 'application/json'}
